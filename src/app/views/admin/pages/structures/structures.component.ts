...
this.getSectors() 
  ...
  getAll(){
    this.structureService.getAll(this.isPaginate,this.pg.pageSize,this.pg.p).subscribe((res:any)=>{
  ...
  store(value:any){
    this.structureService.store(value).subscribe((res:any)=>{
    ...
    (err:any)=>{
      if(err.error.message){
        AppSweetAlert.simpleAlert("error","Structure",err.error.message)
  ...
  update(value:any){
    this.structureService.update(this.selected_data.id,value).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  edit(content:any){
    ...
    this.toastrService.warning("Opération en cours")
      this.loading=true
        this.structureService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.loading=false
          this.getAll()
      },
      (err:any)=>{
        this.loading=false
        console.log(err)
          AppSweetAlert.simpleAlert("error","Gestion des structures",err.error.message)
      })
  }

    onSearchChange() {
  const localResults = this.data.filter(d => d.designation.includes(this.search_text));
  ...
  this.structureService.search({search:this.search_text}).subscribe({
    next: (result:any) => {
