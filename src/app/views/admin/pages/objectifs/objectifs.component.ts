...
export class ObjectifsComponent implements OnInit {
 ...
 loading=false
  ...
  getAll(){
  //  this.data=[]
    this.objectifService.getAll(this.isPaginate,this.pg.pageSize,this.pg.p).subscribe((res:any)=>{
  ...
  update(value:any){
    this.objectifService.update(this.selected_data.id,value).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.modalService.dismissAll()
  ...
  delete(){
    ...
    this.objectifService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  this.objectifService.search({search:this.search_text}).subscribe({
    next: (result:any) => {
