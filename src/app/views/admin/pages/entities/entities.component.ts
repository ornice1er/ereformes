...
export class EntitiesComponent implements OnInit {
 ...
 loading=false
  ...
  getAll(){
    this.entityService.getAll(this.isPaginate,this.pg.pageSize,this.pg.p).subscribe((res:any)=>{
  ...
  store(value:any){
    this.entityService.store(value).subscribe((res:any)=>{
  ...
  update(value:any){
    this.entityService.update(this.selected_data.id,value).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  delete(){
    ...
    this.entityService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
