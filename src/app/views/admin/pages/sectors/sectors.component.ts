...
export class SectorsComponent implements OnInit {
 ...
 loading=false
  ...
  getAll(){
    this.sectorService.getAll(this.isPaginate,this.pg.pageSize,this.pg.p).subscribe((res:any)=>{
  ...
  store(value:any){
    this.sectorService.store(value).subscribe((res:any)=>{
    ...
    (err:any)=>{
      if(err.error.message){
        AppSweetAlert.simpleAlert("error","Secteur",err.error.message)
  ...
  update(value:any){
    this.sectorService.update(this.selected_data.id,value).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  delete(){
    ...
    this.sectorService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  this.sectorService.search({search:this.search_text}).subscribe({
    next: (result:any) => {
